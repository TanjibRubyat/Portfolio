  ...
  <div>
    <section class="hero-area bg-primary" id="parallax">
      ...
      <div class="layer-bg w-100">
        <img
          ...
          src="{{asset('/frontend/assets/images/illustrations/leaf-bg.png')}}"
          alt="bg-shape"
        />
      </div>
      <div class="layer" id="l2">
        <img src="{{asset('/frontend/assets/images/illustrations/dots-cyan.png')}}" alt="bg-shape" />
      </div>
      <div class="layer" id="l3">
        <img src="{{asset('/frontend/assets/images/illustrations/leaf-orange.png')}}" alt="bg-shape" />
      </div>
      <div class="layer" id="l4">
        <img src="{{asset('/frontend/assets/images/illustrations/dots-orange.png')}}" alt="bg-shape" />
      </div>
      <div class="layer" id="l5">
        <img src="{{asset('/frontend/assets/images/illustrations/leaf-yellow.png')}}" alt="bg-shape" />
      </div>
      <div class="layer" id="l6">
        <img src="{{asset('/frontend/assets/images/illustrations/leaf-cyan.png')}}" alt="bg-shape" />
      </div>
      <div class="layer" id="l7">
        <img src="{{asset('/frontend/assets/images/illustrations/dots-group-orange.png')}}" alt="bg-shape" />
      </div>
      <div class="layer" id="l8">
        <img src="{{asset('/frontend/assets/images/illustrations/leaf-pink-round.png')}}" alt="bg-shape" />
      </div>
      <div class="layer" id="l9">
        <img src="{{asset('/frontend/assets/images/illustrations/leaf-cyan-2.png')}}" alt="bg-shape" />
      </div>
      <!-- social icon -->
      ...
      <div class="container">
        <div class="row justify-content-around">
          ...
          <div class="col-lg-3 col-md-4 text-center">
            <img src="{{asset('/frontend/assets/images/experience/icon-1.png')}}" alt="icon" />
            <p class="mb-0">Jan 2007 - Feb 2009</p>
            <h4>Junior UX Designer</h4>
            <h6 class="text-light">WEBEX</h6>
          </div>
          <div class="col-lg-3 col-md-4 text-center">
            <img src="{{asset('/frontend/assets/images/experience/icon-2.png')}}" alt="icon" />
            <p class="mb-0">Mar 2009 - Aug 2014</p>
            <h4>UX & UI Designer</h4>
            <h6 class="text-light">AUGMEDIX</h6>
          </div>
          <div class="col-lg-3 col-md-4 text-center">
            <img src="{{asset('/frontend/assets/images/experience/icon-3.png')}}" alt="icon" />
    ...
    <section class="section position-relative">
      ...
      <img
        ...
        src="{{asset('/frontend/assets/images/backgrounds/education-bg.png')}}"
        alt="bg-image"
      />
    </section>
    <!-- /education -->
        ...
        <div class="row shuffle-wrapper">
          <div class="col-lg-4 col-6 mb-4 shuffle-item">
            <div class="position-relative rounded hover-wrapper">
              <img
                src="{{asset('/frontend/assets/images/portfolio/item-1.png')}}"
                alt="portfolio-image"
          ...
          <div class="col-lg-4 col-6 mb-4 shuffle-item">
            <div class="position-relative rounded hover-wrapper">
              <img
                src="{{asset('/frontend/assets/images/portfolio/item-2.png')}}"
                alt="portfolio-image"
                class="img-fluid rounded w-100"
              />
              <div class="hover-overlay">
          ...
          <div class="col-lg-4 col-6 mb-4 shuffle-item">
            <div class="position-relative rounded hover-wrapper">
              <img
                src="{{asset('/frontend/assets/images/portfolio/item-3.png')}}"
                alt="portfolio-image"
                class="img-fluid rounded w-100"
              />
              <div class="hover-overlay">
          ...
          <div class="col-lg-4 col-6 mb-4 shuffle-item">
            <div class="position-relative rounded hover-wrapper">
              <img
                src="{{asset('/frontend/assets/images/portfolio/item-4.png')}}"
                alt="portfolio-image"
                class="img-fluid rounded w-100"
              />
              <div class="hover-overlay">
          ...
          <div class="col-lg-4 col-6 mb-4 shuffle-item">
            <div class="position-relative rounded hover-wrapper">
              <img
                src="{{asset('/frontend/assets/images/portfolio/item-5.png')}}"
                alt="portfolio-image"
                class="img-fluid rounded w-100"
              />
              <div class="hover-overlay">
    ...
    <section class="section bg-primary position-relative testimonial-bg-shapes">
          ...
          <div class="col-lg-10 mx-auto testimonial-slider">
            ...
            <div class="text-center testimonial-content">
              ...
              <img
                ...
                src="{{asset('/frontend/assets/images/testimonial/client-1.png')}}"
                alt="client-image"
              />
      ...
      <!-- bg shapes -->
      <img
        src="{{asset('/frontend/assets/images/backgrounds/map.png')}}"
        alt="map"
        class="img-fluid bg-map"
      />
      <img
        src="{{asset('/frontend/assets/images/illustrations/dots-group-v.png')}}"
        alt="bg-shape"
        class="img-fluid bg-shape-1"
      />
      <img
        src="{{asset('/frontend/assets/images/illustrations/leaf-orange.png')}}"
        alt="bg-shape"
        class="img-fluid bg-shape-2"
      />
      <img
        src="{{asset('/frontend/assets/images/illustrations/dots-group-sm.png')}}"
        alt="bg-shape"
        class="img-fluid bg-shape-3"
      />
      <img
        src="{{asset('/frontend/assets/images/illustrations/leaf-pink-round.png')}}"
        alt="bg-shape"
        class="img-fluid bg-shape-4"
      />
      <img
        src="{{asset('/frontend/assets/images/illustrations/leaf-cyan.png')}}"
        alt="bg-shape"
        ...
        <div class="client-logo-slider d-flex align-items-center">
          <a href="#" class="text-center d-block outline-0 p-4"
            ><img
              ...
              src="{{asset('/frontend/assets/images/clients-logo/client-logo-1.png')}}"
              alt="client-logo"
          /></a>
          <a href="#" class="text-center d-block outline-0 p-4"
            ><img
              class="d-unset img-fluid"
              src="{{asset('/frontend/assets/images/clients-logo/client-logo-2.png')}}"
              alt="client-logo"
          /></a>
          <a href="#" class="text-center d-block outline-0 p-4"
            ><img
              class="d-unset img-fluid"
              src="{{asset('/frontend/assets/images/clients-logo/client-logo-3.png')}}"
              alt="client-logo"
          /></a>
          <a href="#" class="text-center d-block outline-0 p-4"
            ><img
              class="d-unset img-fluid"
              src="{{asset('/frontend/assets/images/clients-logo/client-logo-4.png')}}"
              alt="client-logo"
          /></a>
          <a href="#" class="text-center d-block outline-0 p-4"
            ><img
              class="d-unset img-fluid"
              src="{{asset('/frontend/assets/images/clients-logo/client-logo-5.png')}}"
              alt="client-logo"
          /></a>
          <a href="#" class="text-center d-block outline-0 p-4"
            ><img
          ...
          <a href="#" class="text-center d-block outline-0 p-4"
            ><img
              class="d-unset img-fluid"
              src="/frontend/assets/images/clients-logo/client-logo-5.png"
              alt="client-logo"
          /></a>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
            <article class="card shadow">
              <img
                ...
                src="{{asset('/frontend/assets/images/blog/post-3.jpg')}}"
                alt="post-thumb"
              />
              <div class="card-body">
                <h4 class="card-title">
          ...
          <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
            <article class="card shadow">
              <img
                class="rounded card-img-top"
                src="{{asset('/frontend/assets/images/blog/post-4.jpg')}}"
                alt="post-thumb"
              />
              <div class="card-body">
                <h4 class="card-title">
