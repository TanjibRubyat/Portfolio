<template>
  <div>
    <section class="hero-area bg-primary" id="parallax">
      ...
      <div class="layer-bg w-100">
        <img
          ...
          src="/frontend/assets/images/illustrations/leaf-bg.png"
          alt="bg-shape"
        />
      </div>
    ...
    <section class="section">
      <div class="container">
        <div class="row justify-content-around">
          ...
          <div class="col-lg-3 col-md-4 text-center">
            <img src="/frontend/assets/images/experience/icon-2.png" alt="icon" />
            <p class="mb-0">Mar 2009 - Aug 2014</p>
            <h4>UX & UI Designer</h4>
            <h6 class="text-light">AUGMEDIX</h6>
          </div>
          <div class="col-lg-3 col-md-4 text-center">
            <img src="/frontend/assets/images/experience/icon-3.png" alt="icon" />
    ...
    <section class="section bg-primary position-relative testimonial-bg-shapes">
          ...
          <div class="col-lg-10 mx-auto testimonial-slider">
            ...
            <div class="text-center testimonial-content">
              ...
              <img
                ...
                src="/frontend/assets/images/testimonial/client-1.png"
                alt="client-image"
              />
      ...
      />
      <img
        src="/frontend/assets/images/illustrations/dots-group-v.png"
        alt="bg-shape"
      ...
      />
      <img
        src="/frontend/assets/images/illustrations/dots-group-sm.png"
        alt="bg-shape"
      ...
      />
      <img
        src="/frontend/assets/images/illustrations/leaf-cyan.png"
        alt="bg-shape"
        ...
        <div class="client-logo-slider d-flex align-items-center">
          <a href="#" class="text-center d-block outline-0 p-4"
            ><img
              ...
              src="/frontend/assets/images/clients-logo/client-logo-1.png"
              alt="client-logo"
          /></a>
          <a href="#" class="text-center d-block outline-0 p-4"
            ><img
              class="d-unset img-fluid"
              src="/frontend/assets/images/clients-logo/client-logo-2.png"
              alt="client-logo"
          /></a>
          <a href="#" class="text-center d-block outline-0 p-4"
            ><img
              class="d-unset img-fluid"
              src="/frontend/assets/images/clients-logo/client-logo-3.png"
              alt="client-logo"
          /></a>
          <a href="#" class="text-center d-block outline-0 p-4"
            ><img
              class="d-unset img-fluid"
              src="/frontend/assets/images/clients-logo/client-logo-4.png"
              alt="client-logo"
          /></a>
          <a href="#" class="text-center d-block outline-0 p-4"
            ><img
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
            <article class="card shadow">
              <img
                ...
                src="/frontend/assets/images/blog/post-3.jpg"
                alt="post-thumb"
              />
              <div class="card-body">
                <h4 class="card-title">
          ...
          <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
            <article class="card shadow">
              <img
                class="rounded card-img-top"
                src="/frontend/assets/images/blog/post-4.jpg"
                alt="post-thumb"
              />
              <div class="card-body">
                <h4 class="card-title">
          ...
          <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
            <article class="card shadow">
              <img
                class="rounded card-img-top"
                src="/frontend/assets/images/blog/post-2.jpg"
                alt="post-thumb"
              />
              <div class="card-body">
                <h4 class="card-title">
