    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <form id="quickForm" novalidate="novalidate" action="{{route('education.update')}}" method="post">
                    @csrf
                    <div class="card-body">                                                
                        <div class="form-group">
                            <label for="name">Passing Year</label>
                            <input type="integer" name="passing_year" class="form-control" value="{{passing_year}}">
                            @error('passing_year')
