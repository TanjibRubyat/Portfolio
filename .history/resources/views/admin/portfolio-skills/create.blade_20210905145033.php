                ...
                <form id="quickForm" novalidate="novalidate" action="{{route('product.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="experiences" class="form-control" id="exampleInputEmail1" placeholder="Skills" aria-describedby="exampleInputEmail1-error" aria-invalid="true">
                            @error('skills')
