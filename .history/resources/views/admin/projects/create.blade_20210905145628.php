                ...
                <form id="quickForm" novalidate="novalidate" action="{{route('product.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Description" aria-describedby="exampleInputEmail1-error" aria-invalid="true">
                            @error('description')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
