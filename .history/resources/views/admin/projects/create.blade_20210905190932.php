    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <form id="quickForm" novalidate="novalidate" action="{{route('project.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="portfolio_id" id="">
                                ...
                                <option value="{{$portfolio->id}}">{{$portfolio->SKILL}}</option>
                                @endforeach
                            </select>
                            @error('portfolio_id')
                            <p class="text-danger">{{$message}}</p>
